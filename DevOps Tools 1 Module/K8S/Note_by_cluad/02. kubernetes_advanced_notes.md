...
#### 🧠 Concept
* **Pod Affinity** 👉 Schedule pods **CLOSE** to specific pods.
* **Pod Anti-Affinity** 👉 Schedule pods **FAR** from specific pods.

👉 **Used for:**
* **Performance:** Keep related services together (e.g., web server and its cache).
* **High Availability:** Spread replicas across different nodes or zones.

***

#### 🔹 Pod Affinity Example (Same Node)
...
👉 **Meaning:**
This pod will be scheduled on the **SAME node** where pods with the label `app=database` are currently running.
