...
**Note:** K8s objects and objects feature can be updated/changed in time. While creating this repo, the version of K8s was v1.22.3. Some sections are trying to be kept up to date. Especially [Creating K8s Cluster with Kubeadm and Containerd](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Kubeadm-Cluster-Setup.md).

# Quick Look (HowTo): Scenarios - Hands-on LAB
- [LAB: K8s Creating Pod - Imperative Way](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-CreatingPod-Imperative.md)
- [LAB: K8s Creating Pod - Declarative Way (With File) - Environment Variable](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8-CreatingPod-Declerative.md) 
- [LAB: K8s Multicontainer - Sidecar - Emptydir Volume - Port-Forwarding](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Multicontainer-Sidecar.md)
- [LAB: K8s Deployment - Scale Up/Down - Bash Connection - Port Forwarding](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Deployment.md)
- [LAB: K8s Rollout - Rollback](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Rollout-Rollback.md)
- [LAB: K8s Service Implementations (ClusterIp, NodePort and LoadBalancer)](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Service-App.md)
- [LAB: K8s Liveness Probe](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Liveness-App.md)
- [LAB: K8s Secret (Declarative and Imperative Way)](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Secret.md)
- [LAB: K8s Config Map](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Configmap.md)
- [LAB: K8s Node Affinity](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Node-Affinity.md)
- [LAB: K8s Taint-Toleration](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Taint-Toleration.md)      
- [LAB: K8s Daemonset - Creating 3 nodes on Minikube](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Daemon-Sets.md)   
- [LAB: K8s Persistent Volume and Persistent Volume Claim](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-PersistantVolume.md)
- [LAB: K8s Stateful Sets - Nginx](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Statefulset.md)  
- [LAB: K8s Job](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Job.md)
- [LAB: K8s Cron Job](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-CronJob.md)
- [LAB: K8s Ingress](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Ingress.md)
- [LAB: Helm Install & Usage](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/Helm.md)
- [LAB: K8s Cluster Setup with Kubeadm and Containerd](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Kubeadm-Cluster-Setup.md)
- [LAB: K8s Cluster Setup with Kubeadm and Docker](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Kubeadm-Cluster-Docker.md)
- [LAB: Helm-Jenkins on running K8s Cluster (2 Node Multipass VM)](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Helm-Jenkins.md)
- [LAB: Enable Dashboard on Real K8s Cluster](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Enable-Dashboard-On-Cluster.md)
- [LAB: K8s Monitoring - Prometheus and Grafana](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Monitoring-Prometheus-Grafana.md)    
- [Kubectl Commands Cheatsheet](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/KubernetesCommandCheatSheet.md)
- [Helm Commands Cheatsheet](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/HelmCheatsheet.md)
...
- **KubeAdm:** You can use the kubeadm tool to create and manage Kubernetes clusters. This is for creating cluster with computers (Goto: [LAB: K8s Kubeadm Cluster Setup](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Kubeadm-Cluster-Setup.md)).
...
- All necessary/most usable commands are listed in the "[Kubernetes Commands Cheatsheet](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/KubernetesCommandCheatSheet.md)". Please have a look to get more information and usage.
...
**Goto the Scenario:** [LAB: K8s Creating Pod - Imperative Way](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-CreatingPod-Imperative.md) 
...
**Goto the Scenario:** [LAB: K8s Creating Pod - Declarative Way (With File) - Environment Variable](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8-CreatingPod-Declerative.md) 
...
**Goto the Scenario:** [LAB: K8s Multicontainer - Sidecar - Emptydir Volume - Port-Forwarding](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Multicontainer-Sidecar.md) 
...
**Goto the Scenario:** [LAB: K8s Deployment - Scale Up/Down - Bash Connection - Port Forwarding](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Deployment.md) 
...
**Goto the Scenario:** [LAB: K8s Rollout - Rollback](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Rollout-Rollback.md)
...
spec:
  ...
  ports:
    - protocol: TCP
      ...
      targetPort: 9376
```    
**Goto the Scenario:** [LAB: K8s Service Implementations (ClusterIp, NodePort and LoadBalancer)](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Service-App.md)
...
**Goto the Scenario:** [LAB: K8s Liveness Probe](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Liveness-App.md)   
...
**Goto the Scenario:** [LAB: K8s Creating Pod - Declarative Way - Environment Variable](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8-CreatingPod-Declerative.md) 
...
**Goto the Scenario:** [LAB: K8s Secret (Declarative and Imperative Way)](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Secret.md)     
...
**Goto the Scenario:** [LAB: K8s Config Map](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Configmap.md)
...
- For a better understanding, please have a look [LAB: K8s Node Affinity](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Node-Affinity.md)    
    
**Go to the Scenario:** [LAB: K8s Node Affinity](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Node-Affinity.md)    
...
- For clarification, please have a look [LAB: K8s Taint Toleration](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Taint-Toleration.md)   
    
**Goto the Scenario:** [LAB: K8s Taint-Toleration](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Taint-Toleration.md)    
...
**Goto the scenario:** [LAB: K8s Daemonset - Creating 3 nodes on Minikube](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Daemon-Sets.md)
...
**Goto the scenario:** [LAB: K8s Persistant Volume and Persistant Volume Claim](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-PersistantVolume.md)    
...
**Goto the scenario:** [LAB: K8s Stateful Sets - Nginx](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Statefulset.md)  
...
**Goto the scenario:** [LAB: K8s Job](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Job.md)
...
**Go to the scenario:** [LAB: K8s Cron Job](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-CronJob.md)
...
**Goto the scenario:** [LAB: K8s Ingress](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Ingress.md)    
...
**Goto the scenario:** [LAB: Enable Dashboard on Real Cluster](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Enable-Dashboard-On-Cluster.md)
...
**Goto the scenario:** [LAB: HELM Install & Usage](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/Helm.md) 

**Goto the scenario:** [LAB: Helm-Jenkins on running K8s Cluster (2 Node Multipass VM)](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Helm-Jenkins.md)   
    
**Goto:** [Helm Commands Cheatsheet](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/HelmCheatsheet.md)
    
       
## Kubernetes Commands Cheatsheet <a name="cheatsheet"></a>

**Goto:** [Kubernetes Commands Cheatsheet](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/KubernetesCommandCheatSheet.md)
...
**Goto:** [LAB: K8s Kubeadm Cluster Setup](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Kubeadm-Cluster-Setup.md) 
    
## Monitoring Kubernetes Cluster with SSH, Prometheus and Grafana <a name="prometheus_grafana"></a>
       
**Goto:** [LAB: K8s Monitoring - Prometheus and Grafana](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Monitoring-Prometheus-Grafana.md)

**Goto:** [LAB: Enable Dashboard on Real K8s Cluster](https://github.com/chanchalKhatua/DevOps-Lecture-Notesfromscalar/blob/main/DevOps%20Tools%201%20Module/K8S/Note_by_cluad/Fastkubernative/K8s-Enable-Dashboard-On-Cluster.md)
